...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['precovenda']) && !empty($_POST['precovenda'])) {
        $precovenda = $_POST['precovenda'];
    } else {
        $precovenda = $nada;
    }

    if (isset($_POST['gastovariavel']) && !empty($_POST['gastovariavel'])) {
        $gastovariavel = $_POST['gastovariavel'];
    } else {
        $gastovariavel = $nada;
    }
        ...
        <div class="formcontainer">
            <form action="/PHP/co.php" method="POST">
                ...
                <div class="pme">
                    ...
                    <input class="pme" type="number" placeholder="Adicione sua informação aqui" required id="precovenda" name="precovenda">
                </div>

                <div class="pmr">
                    <label class="pmr" for="gv">Gasto Variavel </label>
                    <input class="pmr" type="number" placeholder="Adicione sua informação aqui" required id="gastovariavel" name="gastovariavel">
                </div>
